/* Прототип «Агбина»: небольшая интерактивность без зависимостей. */
(function () {
  var d = document;
  ...
  try { if (localStorage.getItem('agbina-hide-tags') === '1') d.body.classList.add('hide-tags'); } catch (e) {}
  function syncToggle() {
    if (!toggle) return;
  ...
  if (toggle) toggle.addEventListener('click', function () {
    ...
    try { localStorage.setItem('agbina-hide-tags', d.body.classList.contains('hide-tags') ? '1' : '0'); } catch (e) {}
    syncToggle();
  });
